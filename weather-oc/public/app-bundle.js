...
var _Weather = __webpack_require__(27);

var _Weather2 = _interopRequireDefault(_Weather);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_Weather2.default, null), document.getElementById("root-weather"));
...
var _WeatherView = __webpack_require__(30);
...
var Weather = function (_Component) {
  ...
  function Weather() {
    ...
    _this.state = {
      city: " Austin",
      temperature: "37 F",
      stats: [{ weather: "Sunny" }, { min: 75 }, { max: 86 }]
    };
    return _this;
  }
  ...
  _createClass(Weather, [{
    ...
    value: function componentDidMount() {
      ...
      var url = "http://api.openweathermap.org/data/2.5/weather?q=Paris&appid=49a125a24252135bdae4287d39136e17";
      ...
      .then(function (data) {
        _this2.setState({
          ...
          stats: [{
            weather: data.weather[0].main }, { min: (data.main.temp_min * (9 / 5) - 459.67).toFixed(0) }, { max: (data.main.temp_max * (9 / 5) - 459.67).toFixed(0) }]
        });
      }).catch(function (e) {
        console.error(e);
      });
    ...
    value: function render() {
      return _react2.default.createElement(_WeatherView2.default, { city: this.state.city, temp: this.state.temperature, stats: this.state.stats });
    }
  }]);
...
function WeatherView(props) {
    var statistics = props.stats.map(function (s) {
